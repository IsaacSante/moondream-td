class Prompt:
    ...
    def text(self) -> str:
        ...
        return f"Is the hand is holding something? If not, respond with 'none'. If the ahnd is grabbing any of the objects, a {objects_part}, then respond with the object name."
